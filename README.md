Ce Git a pour but de permettre de faire des économies et d'augmenter le confort des maisons. 
J'ai fait le choix de mettre ma domotique sur un réseau privé, déconnecté du web pour des raisons de sécurité. 

  - Pilotage d'une VMC double Flux faite pour soit T1 à T4 ou T5 à T7 avec deux vitesses. Désormais trois vitesses en utilisant un relais pour le SH (shunt).
